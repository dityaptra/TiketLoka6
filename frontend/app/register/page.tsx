...
const GoogleIcon = () => (
  /* ... code icon google ... */ <svg className="w-5 h-5" viewBox="0 0 24 24">
    <path
...
export default function RegisterPage() {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-sm border border-gray-300 focus:border-gray-500 focus:outline-none transition-colors text-sm";
          ...
          <div className="w-full max-w-[420px] bg-white rounded-lg shadow-2xl mx-auto lg:ml-auto p-8">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-sm transition-all text-sm"
              >
                <GoogleIcon />
