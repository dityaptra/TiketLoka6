...
export default function DestinationGridSection({
  ...
  const getImageUrl = (url: string | null) => {
    if (!url)
      return "https://images.unsplash.com/photo-1517400508535-b2a1a062776c?q=80&w=2070";
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-gray-600">
              Tempat wisata terfavorit pilihan traveler
            </p>
          </div>
          {limit && (
            <Link
              href="/events"
              className="text-[#0B2F5E] font-semibold hover:underline flex items-center gap-1"
            >
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      "https://images.unsplash.com/photo-1517400508535-b2a1a062776c?q=80&w=2070";
                  }}
                />
