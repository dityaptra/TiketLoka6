        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="relative max-w-2xl mx-auto group">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:block">
              <button className="bg-[#0B2F5E] text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-blue-900 transition">
                Cari
              </button>
            </div>
          </div>
                  ...
                  {section.items.map((item, idx) => {
                    ...
                    return (
                      <div key={idx} className="group">
                        ...
                        >
                          <span
                            className={`text-[15px] font-medium leading-relaxed pr-4 transition-colors ${
                              isOpen
                                ? "text-[#0B2F5E] font-bold"
                                : "text-gray-700"
                            }`}
                          >
                            {item.q}
                          ...
                          <span
                            className={`flex-shrink-0 mt-1 ml-4 transition-transform duration-300 ${
          ...
          <div className="bg-gradient-to-r from-[#0B2F5E] to-[#14427D] rounded-3xl p-8 md:p-14 text-center text-white relative overflow-hidden shadow-2xl shadow-blue-900/30">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-blue-100 mb-8 text-lg leading-relaxed">
                Jangan ragu untuk menghubungi tim support kami. Kami siap
                membantu liburan Anda menjadi pengalaman tak terlupakan.
              </p>
