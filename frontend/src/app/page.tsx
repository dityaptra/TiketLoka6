...
import { ArrowRight, TrendingUp, Calendar, Shield } from "lucide-react";
// Pastikan path import ini sesuai dengan lokasi file komponen Anda
import Navbar from "@/src/components/layout/Navbar";
import Footer from "@/src/components/layout/Footer";
import DestinationGridSection from "@/src/components/home/DestinationGridSection";
import CategoryFilter from "@/src/components/home/CategroyFilter";
...
export default function HomePage() {
  ...
  const sectionTitle = selectedCategory
    ? `Wisata di ${selectedCategory
        .replace(/-/g, " ")
        .replace(/\b\w/g, (l) => l.toUpperCase())}` // Format slug jadi Title Case
    : "Destinasi Populer";
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* Menggunakan Component CategoryFilter yang sudah kita perbaiki fetch-nya */}
      <div className="relative z-20 -mt-8 px-4 mb-8">
        {/* Container ini opsional, tergantung apakah CategoryFilter sudah punya container sendiri */}
