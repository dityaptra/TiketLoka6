  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-sans text-gray-800 antialiased pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-28">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#0B2F5E] tracking-tight">
            Pengaturan Akun
          </h1>
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
              <nav className="flex flex-col p-2">
                ...
                <button
                  ...
                  className="flex items-center gap-3 w-full px-4 py-3.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all"
                >
                ...
                <button
                  onClick={logout}
                  className="flex items-center gap-3 w-full px-4 py-3.5 rounded-xl text-sm font-bold text-red-600 hover:bg-red-50 transition-all mt-1"
                >
